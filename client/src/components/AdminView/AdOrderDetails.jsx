...
import { Package, Truck, CreditCard, Calendar, Hash, MapPin, User, Phone, FileText, X, Settings } from 'lucide-react'
...
const AdOrderDetails = ({ orderDetails, onClose }) => {
    ...
    <DialogContent className='sm:max-w-[550px] max-h-[90vh] overflow-y-auto p-0'>
      ...
      <div className="p-4 sm:p-6 space-y-5">
        ...
        <div>
          ...
          <div className="bg-gradient-to-br from-blue-50/50 to-purple-50/50 dark:from-gray-800/50 dark:to-gray-800/30 rounded-lg p-4 border border-blue-100 dark:border-gray-700/50">
            <Form
              formControls={[
                {
                  label: "Order Status",
