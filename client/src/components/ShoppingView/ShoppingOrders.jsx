...
import { Package, Calendar, Eye, ChevronRight } from 'lucide-react'
...
const ShoppingOrders = () => {
  ...
  // Open dialog when orderDetails is loaded
  useEffect(() => {
  ...
  return (
    <>
      ...
      <Dialog open={openDetailsDialog} onOpenChange={handleCloseDialog}>
        <ShOrderDetails orderDetails={orderDetails} onClose={handleCloseDialog} />
      </Dialog>
    </>
  )
}
